...
public class FruitTreeTest {
    ...
    @Test
    public void nonHumanHitTest(){
        //first damage units
        gob.receiveDamage(40);
        golem.receiveDamage(40);
        undead.receiveDamage(40);
        ...
        //other units doesn't attack
        golem.fight(tree);
        undead.fight(tree);
        assertEquals(60,golem.getLife(),0.01);
        assertEquals(60,undead.getLife(),0.01);
    }
